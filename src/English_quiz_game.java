...
public class English_quiz_game extends JFrame {
    ...
    public static String[] diziYarat(String key) throws SQLException {
        String query = "SELECT " + key + " FROM word";
    ...
    static String[] ingilizce;

    static {
        try {
            ingilizce = diziYarat("ingilizce");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    static String[] turkce;

    static {
        try {
            turkce = diziYarat("turkce");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    static String[] ingilizce_kolay;

    static {
        try {
            ingilizce_kolay = diziYarat("ingilizceKolay");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    static String[] turkce_kolay;

    static {
        try {
            turkce_kolay = diziYarat("turkceKolay");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    static String[] ingilizce_orta;

    static {
        try {
            ingilizce_orta = diziYarat("ingilizceOrta");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    static String[] turkce_orta;

    static {
        try {
            turkce_orta = diziYarat("turkceOrta");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    static String[] ingilizce_zor;

    static {
        try {
            ingilizce_zor = diziYarat("ingilizceZor");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    static String[] turkce_zor;

    static {
        try {
            turkce_zor = diziYarat("turkceZor");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public English_quiz_game() throws SQLException {
